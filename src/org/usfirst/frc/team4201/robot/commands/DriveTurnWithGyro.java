...
public class DriveTurnWithGyro extends Command {
	...
	static double kP = 0.2;        		// Start with P = 10% of your max output, double until you get a quarter-decay oscillation
    static double kI = 0.004;           // Start with I = P / 100
    static double kD = 2;           	// Start with D = P * 10
