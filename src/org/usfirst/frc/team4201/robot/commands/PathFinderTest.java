...
public class PathFinderTest extends Command{
    ...
    public PathFinderTest(String filename, boolean first) {
    ...
    public PathFinderTest(String filename) {
        // Use requires() here to declare subsystem dependencies
        requires(Robot.driveTrain);
        this.filename = filename;
    }
    ...
    protected void execute() {
		...
		//SmartDashboard.putNumber("Pathfinder Point", left.);
		//SmartDashboard.putBoolean("Pathfinder L Finished", left.isFinished());
		//SmartDashboard.putBoolean("Pathfinder R Finished", right.isFinished());
