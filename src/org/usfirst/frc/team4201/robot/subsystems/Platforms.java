...
public class Platforms extends Subsystem{
	...
	DoubleSolenoid leftPlatform = new DoubleSolenoid(RobotMap.PCMOne, RobotMap.leftArmOne, RobotMap.leftArmTwo);
	DoubleSolenoid rightPlatform = new DoubleSolenoid(RobotMap.PCMTwo, RobotMap.rightArmOne, RobotMap.rightArmTwo);
